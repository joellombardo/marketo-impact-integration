<?php
/*
Plugin Name: Marketo Impact Integration
Description: Integrate Marketo forms with Impact.com by capturing specified fields and sending user data.
Version: 1.0.3
...
function mii_plugin_action_links($links) {
	$settings_link = '<a href="options-general.php?page=mii-settings">Settings</a>';
...
function mii_admin_menu() {
	add_options_page(
		'Marketo Impact Integration Settings',
...
function mii_settings_page() {
	...
	?>
	<div class="wrap">
		<h1>Marketo Impact Integration Settings</h1>
		<form method="post" action="">
			...
			<table class="form-table">
				<tr>
					...
					<td><input name="mii_account_sid" type="text" id="mii_account_sid" value="<?php echo esc_attr($account_sid); ?>" class="regular-text"></td>
				</tr>
				<tr>
					<th scope="row"><label for="mii_auth_token">Auth Token</label></th>
					<td><input name="mii_auth_token" type="text" id="mii_auth_token" value="<?php echo esc_attr($auth_token); ?>" class="regular-text"></td>
				</tr>
				<tr>
